...
from src.dependencies.realesrgan.basicsr.utils.registry import LOSS_REGISTRY
...
_model_modules = [importlib.import_module(f'src.dependencies.realesrgan.basicsr.losses.{file_name}') for file_name in loss_filenames]
